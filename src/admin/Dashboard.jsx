...
const Dashboard = () => {
  ...
  const fetchStats = async () => {
    ...
    try {
      ...
      setStats(response.data.data || { total_revenue: 0, total_bookings: 0 });
    } catch (error) {
  ...
  const fetchBookings = async () => {
    ...
    try {
      ...
      setBookings(fetchedBookings.slice(0, 3));
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-pryClr/5 p-4 md:p-6 lg:p-8">
      <div className="mx-auto">
        ...
        >
          ...
          <div className="overflow-x-auto">
            {isBookingsLoading ? (
              ...
              <div className="p-6 text-center text-gray-600 text-sm">No bookings found</div>
            ) : (
        ...
        {/* Latest Event Transactions Table */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
